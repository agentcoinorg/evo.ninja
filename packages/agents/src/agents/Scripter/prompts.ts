...
export const EXPERTISE = `executing and creating scripts to solve basic tasks`;

export const INITIAL_MESSAGES = ({ goal }: ScripterRunArgs): ChatMessage[] => [
  {
    role: "user",
    content: `Purpose:
...
export const LOOP_PREVENTION_PROMPT = `Assistant, you seem to be looping. Try calling findScript, or exiting by calling agent_onGoalAchieved or agent_onGoalFailed.`;