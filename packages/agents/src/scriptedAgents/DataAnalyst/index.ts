...
export class DataAnalystAgent extends ScriptedAgent {
  constructor(context: ScriptedAgentContext) {
    ...
    const config: ScriptedAgentConfig = {
      name: "DataAnalyst",
      expertise:
        "adept at processing CSV files, extracting key data points, and performing calculations to derive insights from the information.",
      initialMessages: ({ goal }) => [
        {
          role: "user",
          content: `You are the Data Analyst Agent, a digital expert in handling CSV datasets. Your primary skill set revolves around extracting,
