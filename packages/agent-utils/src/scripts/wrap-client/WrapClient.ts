...
export class WrapClient extends PolywrapClient {
  ...
  constructor(
    ...
    const builder = new PolywrapClientConfigBuilder()
      ...
      .addBundle("sys")
      .setPackage(
        "ipfs/QmVhzZEswxuhNLxoREpemBGBpMKngMjyLFkdXRBTzP3grQ",
        jsEnginePackage
      )
      .setPackage(
        "plugin/math",
      ...
      .setPackage(
        ...
        PluginPackage.from(() => ({
          ...
          renameSync: async (args: any) => {
            logger.notice(
              "FS.RENAME FROM = " + args.oldPath + " TO = " + args.newPath
            );
      ...
      .setPackage(
        ...
        PluginPackage.from(() => ({
          ...
          getFullYear: async (args: any) =>
            new Date(args.timestamp).getFullYear(),
          getHours: async (args: any) => new Date(args.timestamp).getHours(),
          getMilliseconds: async (args: any) =>
            new Date(args.timestamp).getMilliseconds(),
          getMinutes: async (args: any) =>
            new Date(args.timestamp).getMinutes(),
          getMonth: async (args: any) => new Date(args.timestamp).getMonth(),
          getSeconds: async (args: any) =>
            new Date(args.timestamp).getSeconds(),
          getTime: async (args: any) => new Date(args.timestamp).getTime(),
          getTimezoneOffset: async (args: any) =>
            new Date(args.timestamp).getTimezoneOffset(),
          getUTCDate: async (args: any) =>
            new Date(args.timestamp).getUTCDate(),
          getUTCDay: async (args: any) => new Date(args.timestamp).getUTCDay(),
          getUTCFullYear: async (args: any) =>
            new Date(args.timestamp).getUTCFullYear(),
          getUTCHours: async (args: any) =>
            new Date(args.timestamp).getUTCHours(),
          getUTCMilliseconds: async (args: any) =>
            new Date(args.timestamp).getUTCMilliseconds(),
          getUTCMinutes: async (args: any) =>
            new Date(args.timestamp).getUTCMinutes(),
          getUTCMonth: async (args: any) =>
            new Date(args.timestamp).getUTCMonth(),
          getUTCSeconds: async (args: any) =>
            new Date(args.timestamp).getUTCSeconds(),
          setDate: async (args: any) =>
            new Date(args.timestamp).setDate(args.day),
          setFullYear: async (args: any) =>
            new Date(args.timestamp).setFullYear(args.year),
          setHours: async (args: any) =>
            new Date(args.timestamp).setHours(args.hour),
          setMilliseconds: async (args: any) =>
            new Date(args.timestamp).setMilliseconds(args.millisecond),
          setMinutes: async (args: any) =>
            new Date(args.timestamp).setMinutes(args.minute),
          setMonth: async (args: any) =>
            new Date(args.timestamp).setMonth(args.month),
          setSeconds: async (args: any) =>
            new Date(args.timestamp).setSeconds(args.second),
          setTime: async (args: any) =>
            new Date(args.timestamp).setTime(args.time),
          setUTCDate: async (args: any) =>
            new Date(args.timestamp).setUTCDate(args.day),
          setUTCFullYear: async (args: any) =>
            new Date(args.timestamp).setUTCFullYear(args.year),
          setUTCHours: async (args: any) =>
            new Date(args.timestamp).setUTCHours(args.hour),
          setUTCMilliseconds: async (args: any) =>
            new Date(args.timestamp).setUTCMilliseconds(args.millisecond),
          setUTCMinutes: async (args: any) =>
            new Date(args.timestamp).setUTCMinutes(args.minute),
          setUTCMonth: async (args: any) =>
            new Date(args.timestamp).setUTCMonth(args.month),
          setUTCSeconds: async (args: any) =>
            new Date(args.timestamp).setUTCSeconds(args.second),
          toDateString: async (args: any) =>
            new Date(args.timestamp).toDateString(),
          toISOString: async (args: any) =>
            new Date(args.timestamp).toISOString(),
          toJSON: async (args: any) => new Date(args.timestamp).toJSON(),
          toLocaleDateString: async (args: any) =>
            new Date(args.timestamp).toLocaleDateString(),
          toLocaleString: async (args: any) =>
            new Date(args.timestamp).toLocaleString(),
          toLocaleTimeString: async (args: any) =>
            new Date(args.timestamp).toLocaleTimeString(),
          toString: async (args: any) => new Date(args.timestamp).toString(),
          toTimeString: async (args: any) =>
            new Date(args.timestamp).toTimeString(),
          toUTCString: async (args: any) =>
            new Date(args.timestamp).toUTCString(),
        }))
      )
      .setPackage(
        "plugin/path",
  ...
  async invoke<TData = unknown, TUri extends Uri | string = string>(
    ...
    const uri =
      typeof options.uri === "string" ? options.uri : options.uri.toString();
