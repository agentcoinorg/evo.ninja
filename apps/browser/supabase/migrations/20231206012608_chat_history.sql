...
CREATE UNIQUE INDEX agent_outputs_pkey ON public.agent_outputs USING btree (id);

CREATE UNIQUE INDEX variables_pkey ON public.variables USING btree (id);

alter table "public"."agent_outputs" add constraint "agent_outputs_pkey" PRIMARY KEY using index "agent_outputs_pkey";

alter table "public"."variables" add constraint "variables_pkey" PRIMARY KEY using index "variables_pkey";

alter table "public"."agent_outputs" add constraint "agent_outputs_chat_id_fkey" FOREIGN KEY (chat_id) REFERENCES chats(id) not valid;

alter table "public"."agent_outputs" validate constraint "agent_outputs_chat_id_fkey";
