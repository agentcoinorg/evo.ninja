...
const Disclaimer = ({ handleDisclaimerSelect }: DisclaimerProps) => {
  ...
  return (
    ...
    >
      <div
        className={
          "animate-slide-up mx-auto flex w-full items-center space-x-2 self-center rounded-xl rounded-xl border-2 border-cyan-500/70 bg-gradient-to-b from-cyan-500/50 from-cyan-500/50 to-cyan-700/50 px-2 py-2.5 text-xs text-white opacity-0 shadow-xl backdrop-blur-[4px] md:px-4 md:text-sm"
        }
      >
